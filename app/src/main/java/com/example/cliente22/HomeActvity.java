...
public class HomeActvity extends AppCompatActivity {
    ...
    private void init() {
            ...
            if(item.getItemId() == R.id.nav_sign_out)
            {
                ...
                builder.setTitle("Sign out")
                        ...
                        .setPositiveButton("SIGN OUT", (dialogInterface, i) -> {
                            ...
                            Intent intent = new Intent(HomeActvity.this,SplashScreenActivity.class);
                ...
                dialog.setOnShowListener(dialogInterface -> {
                    dialog.getButton(AlertDialog.BUTTON_POSITIVE)
                            .setTextColor(ContextCompat.getColor(HomeActvity.this,android.R.color.holo_red_dark));
                    dialog.getButton(AlertDialog.BUTTON_NEGATIVE)
                            .setTextColor(ContextCompat.getColor(HomeActvity.this,R.color.colorAccent));
                });
        ...
        txt_name.setText(Common.currentUser != null ? Common.currentUser.getPhoneNumber() : "");
