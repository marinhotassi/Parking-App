package com.example.cliente22.Common;
...
import com.example.cliente22.Model.ClientModel;
...
public class Common {
    public static final String CLIENT_INFO_REFERENCE = "Clients" ;
    public static final String TOKEN_REFERENCE = "Token";
    public static final String LOCATORS_LOCATION_REFERENCES = "LocatorsLocation" ;
    public static final String LOCATORS_INFO_REFERENCES = "LocatorInfo";
    public static final String REQUEST_LOCATOR_TITLE = "RequestLocator";
    public static final String CLIENT_PICKUP_LOCATION  = "PickupLocation";
    public static ClientModel currentUser;

    public static final String NOTI_TITLE = "title";
    public static final String NOTI_CONTENT = "body";
    public static Map<String,LocatorGeoModel> locatorsFound = new HashMap<>();
    public static HashMap<String, Marker> markerList = new HashMap<>();
    public static HashMap<String, AnimationModel> locatorLocationSubscribe = new HashMap<String, AnimationModel>();
